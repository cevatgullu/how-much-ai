...
$script:launcherCreatedByThisRun = $false
$script:launcherCreatedIdentity = $null
$launcherPlan = $null
$script:launcherStagingRoot = $null
$script:launcherProgramsRoot = $null
$script:registeredTaskNames = @('HowMuchAI-Service', 'HowMuchAI-Window')
$bundle = $null
$manifestBytes = $null
$installBytes = $null
$nodeLock = $null
...
$script:bootstrapHashFiles = [ordered]@{
